    ...
    Call() {
        if (-1 === this._timerId) {
            const e = Date.now()
              ...
              , i = this._interval;
            i <= t && this._canRunImmediate ? (this._lastCallTime = e,
        ...
        _OnUpdatePosition(e) {
            if (this._autoAttach) {
                const t = this._elementMap.get(e.elementId)
                  ...
                  , n = (i.style.left = e.left + "px",
                i.style.top = e.top + "px",
                i.style.width = e.width + "px",
                i.style.height = e.height + "px",
                e.fontSize)
                  , o = (null !== n && (i.style.fontSize = n + "em"),
                e.htmlIndex)
                  , a = (t.SetWantHTMLIndex(o),
                s.GetAvailableHTMLIndex(o));
...
{
    const b0 = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(navigator.userAgent)
      , c0 = /android/i.test(navigator.userAgent)
      , d0 = /safari/i.test(navigator.userAgent) && !/(chrome|chromium|edg\/|OPR\/|nwjs)/i.test(navigator.userAgent);
    let n = 0;
    function AddScript(i) {
        const s = document.createElement("script");
        return s.async = !1,
        s.type = "module",
        i.isStringSrc ? new Promise(e => {
...
self["${t}"]();`,
    ...
    let s = 0;
    const j0 = 8
      , k0 = (window.RealFile = window.File,
    [])
      , l0 = new Map
      , m0 = new Map;
    let r = 0;
    const o0 = []
      , p0 = (self.runOnStartup = function(e) {
    ...
    let t = !1;
    window.RuntimeInterface = class P0 {
        constructor(e) {
            ...
            d0 && (this._useWorker = !1),
            "cordova" === this._exportType && this._useWorker && c0) {
        ...
        IsiOSCordova() {
            return b0 && "cordova" === this._exportType
        }
        IsiOSWebView() {
            const e = navigator.userAgent;
            return b0 && IsWebViewExportType(this._exportType) || navigator.standalone || /crios\/|fxios\/|edgios\//i.test(e)
        }
        IsAndroid() {
            return c0
        }
        IsAndroidWebView() {
            return c0 && IsWebViewExportType(this._exportType)
        }
        IsWindowsWebView2() {
        ...
        *_CanDoAndroidVirtualKeyboardDetection() {
        ...
        async _Init(e) {
            ...
            "nwjs" === this._exportType && self.nw) {
                const n = self.nw.Window.get();
                if (n.on("close", () => self.nw.App.quit()),
        ...
        _GetCommonRuntimeOptions(e) {
            return {
                ...
                isFullscreen: P0.IsDocumentFullscreen(),
        ...
        async _InitWorker(e, t) {
            const n = e.workerMainUrl
              , i = ("preview" === this._exportType ? (this._worker = new Worker("previewworker.js",{
                type: "module",
                name: "Runtime"
            }),
            ...
            this._domHandlers = k0.map(e => new e(this)),
        ...
        async _InitDOM(e, t) {
            ...
            await Promise.all(e.runtimeScriptList.map(e => this._MaybeGetPlatformSpecificScriptURL(e))))
              , o = (await Promise.all(n.map(e => AddScript(e))),
        ...
        _OnUpdateCanvasSize(e) {
            if (!this.IsExportingToVideo()) {
                ...
                for (const {canvas: o, htmlWrap: a} of this._canvasLayers)
                    ...
                    a.style.marginTop = n,
                    this._isFirstSizeUpdate && (o.style.display = "",
                    a.style.display = "");
        ...
        ["_OnSetHTMLLayerCount"](e) {
            ...
            if (i < this._canvasLayers.length)
                for (; this._canvasLayers.length > i; ) {
                    const {canvas: h, htmlWrap: c} = this._canvasLayers.pop();
                    c.remove(),
                    this._useWorker && !s ? this._pendingRemoveElements.push(h) : h.remove()
                }
            else if (i > this._canvasLayers.length)
                for (let e = 0, t = i - this._canvasLayers.length; e < t; ++e) {
                    const u = document.createElement("canvas");
                    if (u.classList.add("c3overlay"),
                    this._useWorker) {
                        const m = u.transferControlToOffscreen();
                        d.push(m),
                        l.push(m)
                    } else
                        d.push(u);
                    ...
                    _.classList.add("c3htmlwrap", "c3overlay"),
                    _.setAttribute("interactive", ""),
                    document.body.appendChild(_),
                    u.style.width = n,
                    u.style.height = o,
                    u.style.marginLeft = a,
                    u.style.marginTop = r,
                    _.style.width = n,
                    _.style.height = o,
                    _.style.marginLeft = a,
                    _.style.marginTop = r,
                    this._runtimeDomHandler._AddDefaultCanvasEventHandlers(u),
                    this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(_),
                    this._canvasLayers.push({
                        canvas: u,
                        htmlWrap: _,
                        lastHtmlLayerDomState: {
            ...
            for (const p of this._domHandlers)
                p instanceof window.DOMElementHandler && p._OnHTMLLayersChanged();
        ...
        _UpdateHTMLLayerDOMProperties(i) {
            for (let e = 0, t = Math.min(this._canvasLayers.length, i.length); e < t; ++e) {
                const {htmlWrap: s, lastHtmlLayerDomState: n} = this._canvasLayers[e]
                  , o = i[e]
                  , a = o.isVisible
                  , r = o.opacity
                  , d = o.isInteractive;
                a !== n.isVisible && (s.style.display = a ? "" : "none",
                n.isVisible = a),
                r !== n.opacity && (s.style.opacity = 1 === r ? "" : String(r),
                n.opacity = r),
                d !== n.isInteractive && (s.style.pointerEvents = d ? "" : "none",
                d ? s.setAttribute("interactive", "") : s.removeAttribute("interactive"),
                n.isInteractive = d)
            }
        }
        ...
        _DoUpdateHTMLElementsZOrder() {
            ...
            for (; s < n; ++s) {
                const r = e[s];
                r.GetActualHTMLIndex() !== t && (this._DoUpdateHTMLElementsZOrderOnHTMLLayer(t, e.slice(i, s)),
        ...
        _DoUpdateHTMLElementsZOrderOnHTMLLayer(e, t) {
            if (!(t.length <= 1 || e >= this._canvasLayers.length)) {
                const s = t.map(e => e.GetElement())
                  ...
                  , o = Array.from(n.children).filter(e => i.has(e));
                for (let e = 0, t = 0, i = s.length; e < i; ++e) {
                    const a = s[e]
                      , r = o[t];
                    a === r ? ++t : n.insertBefore(a, r)
                }
            }
        }
        _GetLocalRuntime() {
            ...
            if (e) {
                ...
                if (a) {
                    ...
                    try {
                        ...
                        return console.error(`Exception in '${i}' handler '${s}':`, t),
                        void (null !== o && this._PostResultToRuntime(o, !1, "" + t))
                    }
                    if (null === o)
                        return e;
                    e && e.then ? e.then(e => this._PostResultToRuntime(o, !0, e)).catch(e => {
                        console.error(`Rejection from '${i}' handler '${s}':`, e),
                        this._PostResultToRuntime(o, !1, "" + e)
                    }
                    ) : this._PostResultToRuntime(o, !0, e)
                } else
                    console.warn(`[DOM] No handler '${s}' for component '${i}'`)
            } else
                console.warn(`[DOM] No event handlers for component '${i}'`)
        }
        ...
        CordovaFetchLocalFile(e) {
            ...
            return new Promise( (t, i) => {
                window.resolveLocalFileSystemURL(s, e => {
                    e.file(t, i)
                }
                , i)
            }
        ...
        _HasPermission(i) {
            ...
            return new Promise( (t, e) => s.checkPermission(this._MapPermissionID(s, i), e => t(!!e.hasPermission), e))
        }
        _RequestPermission(i) {
            const s = this._GetPermissionAPI();
            return new Promise( (t, e) => s.requestPermission(this._MapPermissionID(s, i), e => t(!!e.hasPermission), e))
        }
        ...
        _OnWrapperMessage(e, t) {
            if ("entered-fullscreen" === e)
                P0._SetWrapperIsFullscreenFlag(!0),
                this._runtimeDomHandler._OnFullscreenChange();
            else if ("exited-fullscreen" === e)
                P0._SetWrapperIsFullscreenFlag(!1),
                this._runtimeDomHandler._OnFullscreenChange();
            else if ("object" == typeof e) {
                const i = e.type;
                "directory-handles" === i ? this._directoryHandles = t : "wrapper-init-response" === i ? (this._wrapperInitResolve(e),
                this._wrapperInitResolve = null) : "extension-message" === i ? this.PostToRuntimeComponent("runtime", "wrapper-extension-message", e) : console.warn("Unknown wrapper message: ", e)
            } else
        ...
        async _ConvertDataUriToBlobs(t, i) {
            if ("object" == typeof i)
                this._localFileBlobs[t] = new Blob([i.str],{
                    type: i.type
                }),
        ...
        _ParseDataURI(e) {
            ...
            return {
                mime_type: o,
                data: ("base64" === a || "base64" === r ? atob : decodeURIComponent)(s)
            }
        }
        _BinaryStringToBlob(e, t) {
            let i = e.length, s = i >> 2, n = new Uint8Array(i), o = new Uint32Array(n.buffer,0,s), a, r;
            for (a = 0,
            r = 0; a < s; ++a)
                o[a] = e.charCodeAt(r++) | e.charCodeAt(r++) << 8 | e.charCodeAt(r++) << 16 | e.charCodeAt(r++) << 24;
            let d = 3 & i;
            for (; d--; )
                n[r] = e.charCodeAt(r),
                ++r;
...
{
    const Od = self.RuntimeInterface;
    ...
    const Pd = new Map([["OSLeft", "MetaLeft"], ["OSRight", "MetaRight"]])
      , Qd = {
    ...
    function IsKeyboardInputElement(e) {
        return Td.has(e.tagName.toLowerCase()) || IsInContentEditable(e)
    }
    const Ud = new Set(["canvas", "body", "html"]);
    function PreventDefaultOnCanvasOrDoc(e) {
        if (e.target.tagName) {
            const t = e.target.tagName.toLowerCase();
            Ud.has(t) && e.preventDefault()
        }
    }
    ...
    const Wd = "runtime"
      , Xd = class extends self.DOMHandler {
        constructor(e) {
            super(e, Wd),
        ...
        _OnBeforeStartTicking() {
            ...
            this._pageVisibilityIsHidden = !("hidden" !== document.visibilityState && !e),
            {
        ...
        Attach() {
            ...
            window.addEventListener("mousedown", e => this._OnMouseEvent("mousedown", e, Rd)),
            ...
            window.addEventListener("dblclick", e => this._OnMouseEvent("dblclick", e, Qd)),
            window.addEventListener("wheel", e => this._OnMouseWheelEvent("wheel", e, Qd)),
            ...
            (this._vkTranslateYOffset = 0) < i) {
                ...
                if (s) {
                    const n = s.getBoundingClientRect()
                      ...
                      , a = (t - i) / 2;
                    let e = o - a;
                    0 < (e = (e = i < e ? i : e) < 0 ? 0 : e) && (document.body.style.position = "absolute",
        ...
        _PostRuntimeEvent(e, t) {
            this.PostToRuntime(e, t || null, Sd)
        }
        _GetWindowInnerWidth() {
            ...
            if (!this._isExportToVideo && this._enableWindowResizeEvent) {
                ...
                if (this._iRuntime.IsAndroidWebView()) {
                    if (this._enableAndroidVKDetection) {
                        const i = this._iRuntime.CanDoAndroidVirtualKeyboardDetection();
                        if (i && this._lastWindowWidth === e && t < this._lastWindowHeight)
                ...
                this.PostToRuntime("window-resize", {
                    ...
                    innerHeight: t,
                    devicePixelRatio: window.devicePixelRatio,
                    isFullscreen: Od.IsDocumentFullscreen(),
        ...
        _OnFullscreenChange() {
            if (!this._isExportToVideo) {
                const e = Od.IsDocumentFullscreen();
        ...
        _OnPointerEvent(t, i) {
            if (!this._isExportToVideo) {
                ...
                "mouse" === i.pointerType && (this._mousePointerLastButtons = i.buttons)
            }
        }
        ...
        _OnTouchEvent(i, s) {
            if (!this._isExportToVideo)
                for (let e = 0, t = s.changedTouches.length; e < t; ++e) {
                    ...
                    this._PostToRuntimeMaybeSync(i, {
        ...
        _OnScreenReaderTextEvent(e) {
            ...
            if ("create" === t) {
                ...
                s ? s.textContent = e.text : console.warn("[Construct] Missing screen reader text with id " + e.id)
            } else if ("release" === t) {
                const n = document.getElementById("c3-sr-" + e.id);
                n ? n.remove() : console.warn("[Construct] Missing screen reader text with id " + e.id)
            } else
    ...
    ;
    Od.AddDOMHandlerClass(Xd)
}
{
    const Cf = "dispatchworker.js"
      , Df = "jobworker.js";
    self.JobSchedulerDOM = class {
        ...
        async Init() {
            ...
            const e = this._runtimeInterface.GetScriptFolder() + Cf
              , t = (this._dispatchWorker = await this._runtimeInterface.CreateWorker(e, {
                name: "DispatchWorker"
            }),
            new MessageChannel);
        ...
        async _CreateJobWorker() {
            const e = this._jobWorkers.length
              , t = this._runtimeInterface.GetScriptFolder() + Df
...
{
    const Mf = "touch"
      , Nf = class extends self.DOMHandler {
        constructor(e) {
            super(e, Mf),
    ...
    ;
    self.RuntimeInterface.AddDOMHandlerClass(Nf)
}
{
    const Xf = 180 / Math.PI
      , Yf = "audio";
    self.AudioDOMHandler = class extends self.DOMHandler {
        ...
        async _CreateAudioContext(e) {
            ...
            this._iRuntime.IsExportingToVideo())
                ...
                if (this.SupportsWebMOpus() || (i.sampleRate = 48e3),
        ...
        _UnblockAudioContext() {
            if (!this._hasUnblocked) {
                const e = this._audioContext
                  , t = ("suspended" === e.state && e.resume && e.resume(),
        ...
        _ReconnectEffects(e) {
            ...
            for (const n of this.audioInstancesByEffectTag(e))
                n.Reconnect(t);
        ...
        DecodeAudioData(i, e) {
            return e ? this._iRuntime._WasmDecodeWebMOpus(i).then(e => {
        ...
        *audioInstancesByEffectTag(e) {
        ...
        Tick() {
            for (const i of this._analysers)
                i.Tick();
        ...
        async _Play(e) {
            ...
            if (0 < c && !e.trueClock)
                if (this._audioContext.getOutputTimestamp) {
                    ...
                    c = c - performance.now() / 1e3 + this._audioContext.currentTime;
        ...
        _Stop(e) {
            const t = e.tags;
            for (const i of this.audioInstancesMatchingTags(t))
                i.Stop()
        }
        _StopAll() {
            for (const e of this._audioInstances)
        ...
        async _FadeVolume(e) {
            ...
            for (const o of this.audioInstancesMatchingTags(t))
                o.FadeVolume(i, s, n);
            this._MaybeStartTicking()
        }
        _SetMasterVolume(e) {
        ...
        _OnTick(e) {
            ...
            const t = e.listenerPos
              , i = (!t || this._lastListenerPos[0] === t[0] && this._lastListenerPos[1] === t[1] && this._lastListenerPos[2] === t[2] || (this._lastListenerPos[0] = t[0],
            this._lastListenerPos[1] = t[1],
            this._lastListenerPos[2] = t[2],
            this._audioContext.listener.setPosition(t[0], t[1], t[2])),
        ...
        async _AddEffect(e) {
            ...
            for (const a of i) {
                if ("filter" === t)
                    ...
                    (n = new self.C3AudioConvolveFX(this,o.GetAudioBuffer(),...s))._SetBufferInfo(e.bufferOriginalUrl, e.bufferUrl, e.bufferType);
                else if ("flanger" === t)
        ...
        _RemoveEffects(e) {
            ...
            for (const i of t) {
                ...
                for (const o of n)
                    o.Release();
                this._effects.delete(s),
                this._ReconnectEffects(s)
            }
        }
        _AddAnalyser(e) {
        ...
        async _OnLoadState(e) {
            ...
            if (3 !== t) {
                const o = [];
                for (const a of this._audioInstances)
                    a.IsMusic() && 1 === t || !a.IsMusic() && 2 === t ? o.push(a) : a.Release();
        ...
        async _LoadAudioInstance(t, i) {
            if (3 !== i) {
                ...
                if ((!a || 1 !== i) && (a || 2 !== i)) {
                    let e = null;
                    try {
                        e = await this._GetAudioInstance(s, n, o, r, a)
                    } catch (i) {
...
self.C3AudioBuffer = class {
    ...
    static Create(e, t, i, s, n) {
        ...
        return n && o && e._SetHasAnySoftwareDecodedMusic(),
        !n || e.IsPlayMusicAsSound() || o ? new self.C3WebAudioBuffer(e,t,i,s,n,o) : new self.C3Html5AudioBuffer(e,t,i,s,n)
    }
    CreateInstance(e) {
        return new ("html5" === this._api ? self.C3Html5AudioInstance : self.C3WebAudioInstance)(this._audioDomHandler,this,e)
    }
    _Load() {}
    Load() {
...
self.C3WebAudioBuffer = class extends self.C3AudioBuffer {
    ...
    async _Fetch() {
        ...
        if ("cordova" === e.GetExportType() && e.IsRelativeURL(this._url) && e.IsFileProtocol())
            ...
            if (!i.ok)
                throw new Error(`error fetching audio data: ${i.status} ` + i.statusText);
    ...
    self.C3AudioInstance = class {
        ...
        SetPan(e, t, i, s, n, o, a) {
            if (this._isPannerEnabled) {
                ...
                this._pannerConeParams[1] !== r(o) && (this._pannerConeParams[1] = r(o),
                this._pannerNode.coneOuterAngle = r(o)),
                this._pannerConeParams[2] !== a && (this._pannerConeParams[2] = a,
...
;
{
    ...
    self.C3AudioFilterFX = class extends _8 {
    ...
    ,
    self.C3AudioDelayFX = class extends _8 {
        constructor(e, t, i, s) {
            super(e),
            this._type = "delay",
            this._params = [t, i, s],
    ...
    ,
    self.C3AudioConvolveFX = class extends _8 {
        constructor(e, t, i, s) {
            super(e),
    ...
    ,
    self.C3AudioFlangerFX = class extends _8 {
        constructor(e, t, i, s, n, o) {
            super(e),
            this._type = "flanger",
    ...
    ,
    self.C3AudioPhaserFX = class extends _8 {
        constructor(e, t, i, s, n, o, a) {
            super(e),
            this._type = "phaser",
            this._params = [t, i, s, n, o, a],
    ...
    ,
    self.C3AudioGainFX = class extends _8 {
        constructor(e, t) {
            super(e),
            this._type = "gain",
            this._params = [t],
    ...
    ,
    self.C3AudioStereoPanFX = class extends _8 {
        constructor(e, t) {
            super(e),
    ...
    ,
    self.C3AudioTremoloFX = class extends _8 {
        constructor(e, t, i) {
            super(e),
            this._type = "tremolo",
            this._params = [t, i],
    ...
    ,
    self.C3AudioRingModFX = class extends _8 {
        constructor(e, t, i) {
            super(e),
            this._type = "ringmod",
            this._params = [t, i],
    ...
    ,
    self.C3AudioDistortionFX = class extends _8 {
        constructor(e, t, i, s, n, o) {
            super(e),
    ...
    ,
    self.C3AudioCompressorFX = class extends _8 {
        constructor(e, t, i, s, n, o) {
            super(e),
    ...
    ,
    self.C3AudioAnalyserFX = class extends _8 {
        constructor(e, t, i) {
            super(e),
            this._type = "analyser",
            this._params = [t, i],
...
}
{
    ...
    t = e,
    i && i._OnBeforeInstallPrompt(),
    !1));
    const Qk = "browser"
      , Rk = class extends self.DOMHandler {
        constructor(e) {
            super(e, Qk),
            this._exportType = "",
        ...
        _OnNavigate(e) {
            ...
            if ("back" === t)
                ...
                const i = e.url
                  , s = e.target
                  , n = e.exportType;
                self.cordova && self.cordova.InAppBrowser ? self.cordova.InAppBrowser.open(i, "_system") : "preview" === n || "linux-cef" === n || this._iRuntime.IsAnyWebView2Wrapper() ? window.open(i, "_blank") : this._isConstructArcade || (2 === s ? window.top.location = i : 1 === s ? window.parent.location = i : window.location = i)
            } else if ("new-window" === t) {
                const o = e.url
                  , a = e.tag;
                self.cordova && self.cordova.InAppBrowser ? self.cordova.InAppBrowser.open(o, "_system") : window.open(o, a)
            }
        }
        _OnRequestFullscreen(t) {
            if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType)
                ...
                const i = {
                  ...
                  , s = t.navUI
                  , n = (1 === s ? i.navigationUI = "hide" : 2 === s && (i.navigationUI = "show"),
                document.documentElement);
                let e;
                n.requestFullscreen ? e = n.requestFullscreen(i) : n.mozRequestFullScreen ? e = n.mozRequestFullScreen(i) : n.msRequestFullscreen ? e = n.msRequestFullscreen(i) : n.webkitRequestFullScreen && (e = void 0 !== Element.ALLOW_KEYBOARD_INPUT ? n.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT) : n.webkitRequestFullScreen()),
    ...
    ;
    self.RuntimeInterface.AddDOMHandlerClass(Rk)
}
